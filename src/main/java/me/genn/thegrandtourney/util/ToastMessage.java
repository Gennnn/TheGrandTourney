...
import me.genn.thegrandtourney.util.DisplayMessage;
...
public class ToastMessage extends DisplayMessage	{
    ...
    public ToastMessage(String id, String title, String icon, JavaPlugin pl, String frame)	{
        this(new NamespacedKey(pl, id), title, icon, pl);
        this.frame = frame;
    }
